...
**The answer is: optimizing $\mathcal{L}_{FM} (\theta)$ 
is equivalent to optimizing $\mathcal{L}_{CFM} (\theta)$.**
...
as we kown (continuity equation): $\frac{\partial p_t(x)}{\partial t} = - \nabla_x \cdot (p_t(x) \cdot u_t(x))$, therefore:
